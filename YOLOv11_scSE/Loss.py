...
from YOLOv11_scSE.Utility import make_anchors ,bbox_iou, df_loss, bbox2dist, dist2bbox, xywh2xyxy, TaskAlignedAssigner
...
class DetectionLoss(BaseLoss):
    ...
    def clear_progress_bar(self,bar_length=30):
        print("\r" + " " * (bar_length + 20), end="\r")
